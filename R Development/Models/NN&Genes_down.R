...
data <- datos_exp[,c("IPW","DOCK10","PSMB8","CASC5","SNRPN","ELOVL4","LOC728392","CA12","OsStatus")]



data_matrix <- model.matrix(~IPW+DOCK10+PSMB8+CASC5+SNRPN+ELOVL4+LOC728392+CA12+OsStatus, data=data)
