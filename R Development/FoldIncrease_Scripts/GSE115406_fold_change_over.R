...
df$fold_1 <- df$GSM3177688 / df$GSM3177682
df$fold_2 <- df$GSM3177689 / df$GSM3177683
df$fold_3 <- df$GSM3177690 / df$GSM3177684
...
write.table(df,"../data/geo/fold_increase/GSE115406_fold_increase_over.csv", row.names = FALSE,sep = ',', col.names = FALSE)
