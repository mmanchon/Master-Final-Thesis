...
sapply(datos_exp[,c("EGLN2"   ,"RFFL"     ,"SESN3"   ,"C12orf50","EPHA5","EVX1","DDX58",
                    "BRD7P3"   ,"C19orf26","KANK2"    ,"POM121L8P","DMGDH"    ,"ITGA4"   ,"KCNJ6"    ,"MCM4"    ,
                    "ASAH1"    ,"MSMB"    ,"MUC7"     ,"CNOT2"   ,
                    "MLXIPL"   ,"ROBO4"   ,"LGR4"     ,"PTPRC"   ,
                    "SLC22A23" ,"TFRC"    ,"WT1"      ,"ZFY"     ,
                    "CACNA1C"  ,"CXorf36" ,"SCUBE1"   ,"PTPN5")],
       function(x) sum(is.na(x)))

# Correlation analysis

temp<-datos_exp[,c("EGLN2"   ,"RFFL"     ,"SESN3"   ,"C12orf50","EPHA5","EVX1","DDX58",
                   "BRD7P3"   ,"C19orf26","KANK2"    ,"POM121L8P","DMGDH"    ,"ITGA4"   ,"KCNJ6"    ,"MCM4"    ,
                   "ASAH1"    ,"MSMB"    ,"MUC7"     ,"CNOT2"   ,
                   "MLXIPL"   ,"ROBO4"   ,"LGR4"     ,"PTPRC"   ,
                   "SLC22A23" ,"TFRC"    ,"WT1"      ,"ZFY"     ,
...
vars<-c("EGLN2"   ,"RFFL"     ,"SESN3"   ,"C12orf50","EPHA5","EVX1","DDX58",
        "BRD7P3"   ,"C19orf26","KANK2"    ,"POM121L8P","DMGDH"    ,"ITGA4"   ,"KCNJ6"    ,"MCM4"    ,
        "ASAH1"    ,"MSMB"    ,"MUC7"     ,"CNOT2"   ,
        "MLXIPL"   ,"ROBO4"   ,"LGR4"     ,"PTPRC"   ,
        "SLC22A23" ,"TFRC"    ,"WT1"      ,"ZFY"     ,
        "CACNA1C"  ,"CXorf36" ,"SCUBE1"   ,"PTPN5","OS_STATUS")
...
aux <- temp[, which(names(temp) %in% c("EGLN2","C19orf26","POM121L8P", "MCM4", "MLXIPL", "ROBO4", "LGR4","TFRC","OS_STATUS"))]
